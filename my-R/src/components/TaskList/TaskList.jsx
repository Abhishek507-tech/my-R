...
const TaskList = () => {
  return (
    <div id='tasklist' className='h-[53%] flex overflow-x-auto item-center justify-start gap-5 w-full py-5 mt-10 rounded-xl
    '>
      <div className='flex-shrink-0 h-full w-[300px] bg-red-300 rounded-xl p-6'>
        ...
        <h2 className='mt-5 text-2xl font-semibold mt-2'>Make a youtube video</h2>
