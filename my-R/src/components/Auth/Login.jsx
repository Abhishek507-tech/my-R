    ...
    <div className='flex h-screen w-screen items-center  justify-center'>
      ...
      <div className='border-2 rounded-xl border-emerald-600 p-20'>
        ...
        className='flex flex-col items-center justify-center'>
            ...
            <input required  className=' outline-none border-2 border-emerald-500 rounded-full py-3 px-5 text-xl bg-transparent mt-4 placeholder:text-gray-500  ' type="password" placeholder='Enter your password'/>
